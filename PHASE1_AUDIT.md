...
| Regression protection | Baseline was 23 passing tests. | Added 11 foundation and closure tests without breaking existing behavior. | 34 tests pass; Ruff passes. | `tests/test_phase1_foundation.py` |
